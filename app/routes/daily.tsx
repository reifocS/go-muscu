          ...
          return (
            <div className="0" key={s.id}>
              <details open={i === data.workout.set.length - 1}>
                <summary className="flex h-[60px] items-center justify-between border-t-2 border-gray-500 bg-gray-700">
                ...
                <div className="flex items-center justify-center">
                  <table className="w-full table-fixed divide-y border-none">
                    <TableHead />
                    <TableBody
